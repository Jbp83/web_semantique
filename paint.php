...
<form name="tools" action="req_paint.php" method="post">
	Mot à faire deviner <input  required type="text" name="mot" placeholder="Mot">
	<br />
	Destinataire <input type="text" required name="dest" placeholder="Destinataire">
	<br />
    <!-- ici, insérez un champs de type range avec id="size", pour choisir un entier entre 0 et 4) -->
    <input type="range" id="size" min="0" max="3" step="1" name="size"/>
    ...
    <input type="color" id="color" value="<?php echo '$_SESSION[\"couleur\"]'; ?>" name="color"/>
